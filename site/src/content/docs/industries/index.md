...
description: "How Microsoft employees and partners can use the dc2fabric industry stories in customer conversations"
sidebar:
  order: 0
---
...
the Azure TCO Calculator, Fabric readiness reviews, and customer telemetry for
customer-specific estimates and commitments.
:::

## Stories and Guide

- [Manufacturing: Contoso Industries](/dc2fabric/industries/manufacturing/) —
  supply chain visibility, ERP/MES migration, and predictive maintenance.
- [Financial Services: Woodgrove Bank](/dc2fabric/industries/financial-services/) —
  regulatory reporting, fraud detection, and customer data unification.
...
For Microsoft employees, the stories provide a shared narrative for MCEM-stage
planning and customer alignment. For partners, they provide a repeatable way to
position services without making unsupported savings, downtime, or regulatory
claims. In both cases, the strongest motion is evidence-led: strategy first,
assessment second, roadmap third, then governed execution.
